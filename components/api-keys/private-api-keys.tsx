...
export default function PrivateApiKeys() {
            ...
            <CardContent className="px-[21px] py-[21px]  space-y-5">
                ...
                <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                    <div className="flex items-center gap-[10px]">
                        {/* Lock Icon Box */}
                        <Icons.privateIcon className="h-10 w-10 "/>
                        <h2 className="text-lg  font-semibold text-[#1C1917] dark:text-muted-foreground">Private API
                            Keys</h2>
                    </div>

                    {/* Create Button - Custom Yellow Style */}
                    <CreateKeyModal
                        type="private"
                        onSubmit={(data) => console.log("Creating Private Key:", data)}
                        trigger={
                            <Button
                                variant="outline"
                ...
                <p className="text-[#70645C] text-sm">
                    Use these for backend integrations.
                </p>
                    ...
                    <div className="overflow-x-auto">
                        <Table>
                            <TableHeader className="">
                                <TableRow className="hover:bg-muted border-b border-zinc-200">
                                    <TableHead
                            ...
                            <TableBody>
                                {apiKeys.map((item, index) => (
                                    <TableRow key={index} className="hover:bg-muted border-none">
                                        {/* Name */}
                                        <TableCell
                                            className="text-center text-zinc-900 dark:text-muted-foreground font-medium py-6">
                                            {item.name}
                                        </TableCell>

                                        {/* KEY - Masked display with Eye icon */}
