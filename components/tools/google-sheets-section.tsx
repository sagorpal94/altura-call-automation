...
export default function GoogleSheetsSection({ form }: { form: UseFormReturn<ToolFormValues> }) {
    return (
                    ...
                    <FormItem className="space-y-1.5">
                        ...
                        <FormControl>
                            <Input
                                ...
                                className="h-11 border-[#FDE047] focus-visible:ring-0 rounded-lg"
                            />
                        </FormControl>
                ...
                render={({ field }) => (
                    <FormItem className="space-y-1.5">
                        ...
                        <FormControl>
                            <Input
                                {...field}
                                placeholder="Enter Range (e.g., Sheet1, Sheet1!A:Z)"
                                className="h-11 border-[#FDE047] focus-visible:ring-0 rounded-lg"
                            />
                        </FormControl>
                        <FormDescription className="text-[11.5px] text-zinc-500 font-medium">
